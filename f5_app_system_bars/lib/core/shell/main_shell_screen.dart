...
class _MainShellScreenState extends State<MainShellScreen> {
  ...
  Widget build(BuildContext context) {
    // Mientras se ve esta pantalla (con nuestra propia barra inferior
    // navy), la barra de gestos/botones del sistema toma el mismo color
    // — se ven como una sola franja continua en vez de dos separadas.
